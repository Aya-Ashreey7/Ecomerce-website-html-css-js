...
blackScreen.addEventListener("click", (eo) => {
  ...
  let nameOfDeletedProduct = eo.target.parentElement.getElementsByClassName("product-name")[0].innerText
  nameOfDeletedProduct = nameOfDeletedProduct.slice(1, nameOfDeletedProduct.length - 1);
